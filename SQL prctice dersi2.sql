...
-- SORU2: sirketler tablosundaki tum sirketleri(isimleri) ve bu sirketlere ait olan
...
select B.sirket_id,B.sirket_isim,A.siparis_id,A.siparis_tarihi from sirketler as B
left join siparisler as A
on A.sirket_id = B.sirket_id;-- ortak değerler üzerine ON yazıyoruz
--=============== union  ile
