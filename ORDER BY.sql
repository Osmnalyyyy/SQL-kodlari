...
select * from kisiler order by adres asc; --ASCENDING(asc) yazmasak da sıralı veriri
-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select * from kisiler order by adres desc;--DESCANDING(desc) tersten sıralama yapar
