...
--"burada urunler ve tedarikciler tablolarini yeniden olusturduk"
update urunler 
set urun_isim = (select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve') -- alt sorgu yaptık
